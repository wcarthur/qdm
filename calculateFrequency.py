...
if __name__ == '__main__':
    ...
    obstc = load_obs_data("./data/obs/ibtracs.since1980.list.v04r00.csv", domain)
    ...
    g.add_legend()
    plt.savefig("data/figures/tclv_frequency_projections.png", bbox_inches="tight", dpi=600)
    freqdf.to_excel("data/output/tclv_frequency_projections.xlsx", index=False)
